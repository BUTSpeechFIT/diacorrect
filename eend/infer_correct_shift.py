...
from train_correct import _convert
...
def parse_arguments() -> SimpleNamespace:
    ...
    parser.add_argument('--infer-sap-dir', help='inference sap scp.')
...
if __name__ == '__main__':
    ...
    for i, batch in enumerate(infer_loader):
        ...
        # remove sigmoid
        sap = sigmoid_inverse(sap)
        # calibration
        sap = sap + args.shift

        name = batch['names'][0]
        with torch.no_grad():
            y_pred = model.estimate_sequential(input, sap, args)[0]
